translate turkish strings:
    ...
    new "Bu oyun yalnızca\Patreon'dan aldığımız\tüm destekle mümkün oldu"

    # game/code/credits/credit_sprites.rpy:123
    old "Huge thanks to\nall of our fans\nand everyone who\nsupported us and\nhelped to bring\nthis story to life"
    new "Tüm hayranlarımıza\ve bizi destekleyen ve\bu hikayeyi hayata geçirmemize yardımcı olan herkese çok teşekkür ederiz"

    # game/code/credits/credit_sprites.rpy:160
    old "Thank you for playing {color=#d18fe7}Taboo University Book One{/color}!"
    new "{color=#d18fe7}Taboo Üniversitesi Birinci Kitabı{/color} oynadığınız için teşekkürler!"

    # game/code/credits/credit_sprites.rpy:161
    old "See you soon in {color=#d18fe7}Book Two{/color}!"
    new "Yakında {color=#d18fe7}Kitap İki{/color}'de görüşmek üzere!"
...
translate turkish strings:
    ...
    # game/code/credits/credit_sprites.rpy:115
    old "This game was only\nmade possible with\nall the support we have\nfrom our fans"
    new "Bu oyun ancak\taraftarlarımızdan aldığımız\desteklerle mümkün oldu"
