...
translate chinese strings:
    ...
    new "Went missing February 15th during the Winner's Club party"

    # game/code/data/ib_descriptions.rpy:2
    old "Used to be Nia's Guide."
    new "Used to be Nia's Guide."
    ...
    new "Worked as a part-time model and actress"

    # game/code/data/ib_descriptions.rpy:2
    old "Involved with the Winner's Club"
    new "Involved with the Winner's Club"

    # game/code/data/ib_descriptions.rpy:2
    old "Got mentoring from Diana Mills."
    new "Got mentoring from Diana Mills."
    ...
    new "Does not have enough power within The Winner's Group to allow outsiders to come in or choose new candidates."

    # game/code/data/ib_descriptions.rpy:2
    old "A friend of Leia."
    new "A friend of Leia."

    # game/code/data/ib_descriptions.rpy:2
    old "Friends with Simon."
    new "Friends with Simon."
    ...
    new "Blind. Best friends with Josie."

    # game/code/data/ib_descriptions.rpy:2
    old "My other roommate."
    new "My other roommate."

    # game/code/data/ib_descriptions.rpy:2
    old "Only person aware of the investigation."
    new "Only person aware of the investigation."

    # game/code/data/ib_descriptions.rpy:2
    old "My on-campus contact."
    new "My on-campus contact."
    ...
    new "Helper at campus library."

    # game/code/data/ib_descriptions.rpy:2
    old "A friend of Nia and Maria."
    new "A friend of Nia and Maria."
    ...
    # game/code/data/ib_descriptions.rpy:2
    old "Morgan's involved with illegal fighting."
    new "Morgan's involved with illegal fighting."

    # game/code/data/ib_descriptions.rpy:2
    old "Tends the Guns n' Rosette bar."
    new "Tends the Guns n' Rosette bar."
    ...
    new "Was previously involved with the Winners Club."

    # game/code/data/ib_descriptions.rpy:2
    old "Stalks the Winners Club."
    new "Stalks the Winners Club."
...
translate chinese strings:
    ...
    new "Oleysa is noticeably absent from the party. Need to find out why."
    ...
    new "Got kicked from the Winner's Group because she crashed an important party that Isa threw."
    ...
    new "Isa orchestrated Sam's exile from the Winner's Group."
