...
translate french strings:
    ...
    new "Suivre le chemin de Monika."
    ...
    new "Suivre le chemin de Delphia."
    ...
    new "Suivre le chemin de Morgan."
    ...
    new "Suivre le chemin de Corinne."
    ...
    new "Suivre le chemin de Nirmala."
    ...
    new "Atteindre la fin du prologue."
    ...
    new "Terminer la Partie 2 du Vainqueur."
    ...
    new "Terminer la Partie 2 du Culte."
    ...
    new "Terminer la Partie 2 du Syndicat."
    ...
    new "Perdre le tournoi du Vainqueur."
    ...
    new "Vivre un éveil spirituel avec Nia."
    ...
    new "Voir l'explosion de l'entrepôt de la Guêpe."
    ...
    new "Avoir une relation à trois avec Nia et Silvia."
    ...
    new "Avoir une relation à trois avec Nia et Zemfira."
    ...
    new "Avoir une relation à trois avec Zemfira et Silvia."
    ...
    new "Cliquez sur le personnage d'arrière-plan de la rue du Boucher."
    ...
    new "Gagner le mini-jeu de Greg."
    ...
    new "Gagner 18+ points avec un groupe."
    ...
    new "Avoir des relations avec Monika et embrasser Olesya."
    ...
    new "Embrasser Phoebe et dire la vérité à Fleur et Asami."
    ...
    new "Débloquer un personnage sur le tableau d'enquête."
    ...
    new "Débloquer 20 personnages sur le tableau d'enquête."
    ...
    new "Débloquer 40 personnages sur le tableau d'enquête."
    ...
    new "Avoir des relations avec 10 filles."
    ...
    new "Avoir des relations avec toutes les filles."
    ...
    new "Suivre les chemins de Diana et Ronja."
    ...
    new "Vivre tous les fétiches à la fête."
    ...
    new "Jeter Brigitta dans la piscine."
    ...
    new "Se faire blue baller par Nia et Zemfira à la fête."
    ...
    new "Cliquez sur l'option non-cliquable dans le cauchemar."
    ...
    new "Jouer la scène post-crédits."
